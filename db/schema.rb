...
ActiveRecord::Schema[7.1].define(version: 2024_09_16_121747) do
  ...
  create_table "seller_business_infos", force: :cascade do |t|
    ...
    t.bigint "shop_info_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shop_info_id"], name: "index_seller_business_infos_on_shop_info_id"
    t.index ["user_id"], name: "index_seller_business_infos_on_user_id"
  end

  create_table "seller_on_boardings", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.integer "step", null: false
    t.string "status", null: false
    t.index ["user_id"], name: "index_seller_on_boardings_on_user_id"
  end

  create_table "shop_bank_details", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shop_info_id"], name: "index_shop_bank_details_on_shop_info_id"
    t.index ["user_id"], name: "index_shop_bank_details_on_user_id"
  end

  create_table "shop_billing_addresses", force: :cascade do |t|
    t.string "country"
    t.string "state"
    t.string "city"
    t.string "zip_code"
    ...
    t.bigint "user_id", null: false
    t.bigint "shop_billing_info_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shop_billing_info_id"], name: "index_shop_billing_addresses_on_shop_billing_info_id"
    t.index ["user_id"], name: "index_shop_billing_addresses_on_user_id"
  end

  create_table "shop_billing_infos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shop_info_id"], name: "index_shop_billing_infos_on_shop_info_id"
    t.index ["user_id"], name: "index_shop_billing_infos_on_user_id"
  end
  ...
  create_table "shop_infos", force: :cascade do |t|
    ...
    t.string "area", null: false
    t.string "state", null: false
    t.string "tax_payer_type", null: false
  ...
  create_table "spree_line_items", force: :cascade do |t|
    ...
    t.index ["approver_id"], name: "index_spree_line_items_on_approver_id"
    t.index ["canceler_id"], name: "index_spree_line_items_on_canceler_id"
    t.index ["order_id"], name: "index_spree_line_items_on_order_id"
    t.index ["shop_id"], name: "index_spree_line_items_on_shop_id"
  ...
  create_table "spree_shipping_methods", force: :cascade do |t|
    ...
    t.index ["shop_id"], name: "index_spree_shipping_methods_on_shop_id"
    t.index ["tax_category_id"], name: "index_spree_shipping_methods_on_tax_category_id"
    t.index ["user_id"], name: "index_spree_shipping_methods_on_user_id"
  end
  ...
  create_table "spree_stock_locations", force: :cascade do |t|
    ...
    t.index ["shop_id"], name: "index_spree_stock_locations_on_shop_id", unique: true
  ...
  add_foreign_key "property_values", "spree_properties", column: "property_id"
  add_foreign_key "seller_business_infos", "shop_infos"
  add_foreign_key "seller_business_infos", "spree_users", column: "user_id"
  add_foreign_key "seller_on_boardings", "spree_users", column: "user_id"
  add_foreign_key "shop_bank_details", "shop_infos"
  add_foreign_key "shop_bank_details", "spree_users", column: "user_id"
  add_foreign_key "shop_billing_addresses", "shop_billing_infos"
  add_foreign_key "shop_billing_addresses", "spree_users", column: "user_id"
  add_foreign_key "shop_billing_infos", "shop_infos"
  add_foreign_key "shop_billing_infos", "spree_users", column: "user_id"
  add_foreign_key "shop_infos", "shops"
  add_foreign_key "shop_infos", "spree_users", column: "user_id"
  add_foreign_key "shops", "spree_users", column: "user_id"
  ...
  add_foreign_key "spree_line_items", "shops"
  ...
  add_foreign_key "spree_stock_locations", "shops"
